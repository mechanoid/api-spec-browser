...
const fullQualified = (req, mountpath = '') => path => new URL(join(mountpath, path), originalHost(req))
...
router.use('/.well-known/specs', express.static(resolve(process.cwd(), 'examples/example-service-api')))
